...
//        assertThrows(ValidationException.class, () -> userController.createUser(new User("", "fdg",
...
//        assertThrows(ValidationException.class, () -> userController.createUser(new User("na@", "asd sa ",
//                "sd", LocalDate.of(2000, 2, 10))));
//    }
//
...
//    void updateUser() {
//        User create = userController.createUser(new User("na@", "fdg", "sd", LocalDate.of(2000, 2, 10)));
//        userController.updateUser(new User(1, "na@na", "fdg", "sd", LocalDate.of(2000, 2, 10)));
//        assertEquals(userController.getAllUser(), List.of(new User(1, "na@na", "fdg", "sd", LocalDate.of(2000, 2, 10))));
//    }
}